...
import com.line.base.recyclerview.RecyclerItemBinder
...
class WebViewItemBinder() : RecyclerItemBinder<WebViewItem, LayoutWebviewItemBinding>() {
    ...
    override fun convert(
        ...
        viewBinding: LayoutWebviewItemBinding,
        data: WebViewItem
    ) {
        var webView = viewBinding.webView
        ...
        webView.webChromeClient = object :WebChromeClient(){
            override fun onConsoleMessage(consoleMessage: ConsoleMessage?): Boolean {
                consoleMessage?.apply {
                    Log.d("article", "${message()} -- From line ${lineNumber()} of ${sourceId()}")
                }
                return true;
            }
        }
