...
import com.line.base.entity.WebViewItem
import com.line.base.recyclerview.MainActivityAdapter
import com.line.base.recyclerview.TextItemBinder
...
class ArticleWebActivity : BaseActivity() {
    ...
    var activityItems: MutableList<Any> = mutableListOf()
...
//        }
//        body =
        "<html><head><style>img{width:100%}</style><script type='text/javascript'>function show(){window.demo.javaShow()} </script></head><body>$body</body></html>"

//        String titleHTML = "<p><span style='font-size:18px;'><strong>" + body + "</strong></span></p>";// 标题
//
//        webView.loadDataWithBaseURL("file:///android_asset/article/", body, "text/html", "utf-8", null);
//        webView.loadUrl("file:///android_asset/article/article3.html")
