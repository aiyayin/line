...
import com.yin.javalib.tree.Tree
import com.yin.javalib.tree.TreeNode
import com.line.base.BaseActivity
import com.line.base.util.ToolUtil.toast
...
class TreeActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.testGsonSparseBooleanArray -> {
                testGsonSparseBooleanArray()
            }
            R.id.level -> {
